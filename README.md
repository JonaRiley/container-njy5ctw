...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-njy5ctw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-njy5ctw.containers.anotherwebservice.com/
...
```
git clone git@github.com:JonaRiley/container-njy5ctw.git
cd container-njy5ctw
```
...
```
docker attach container-njy5ctw
```
